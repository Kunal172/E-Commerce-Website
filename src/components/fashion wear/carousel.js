...
import '../fashion wear/utils/carousel.css';
...
export const Carousel = () =>
{
    return (
        <>
            <div id="carouselExampleFade" class="carousel slide carousel-fade carousel_1" data-bs-ride="carousel">
            ...
            <div id="carouselExampleControls" class="carousel slide carousel_2" data-bs-ride="carousel">
                <div class="carousel-inner banner">
                    <div class="carousel-item active">
            ...
            <div id="carouselExampleInterval" class="carousel slide carousel_3" data-bs-ride="carousel">
                <div class="carousel-inner banner">
